...
public class _jet_main implements JET2Template {
    ...
    private static final TagInfo _td_ws_file_17_3 = new TagInfo("ws:file", //$NON-NLS-1$
            17, 3,
            new String[] {
                "template", //$NON-NLS-1$
                "path", //$NON-NLS-1$
            ...
            new String[] {
                "templates/treeeditor.jet", //$NON-NLS-1$
                "{$ePackage/@name}TreeNodeEditor.py", //$NON-NLS-1$
            } );
    private static final TagInfo _td_ws_file_19_3 = new TagInfo("ws:file", //$NON-NLS-1$
            ...
            new String[] {
                "templates/grapheditor.jet", //$NON-NLS-1$
                "{$ePackage/@name}GraphEditor.py", //$NON-NLS-1$
            } );
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        while (_jettag_ws_project_14_1.okToProcessBody()) {
            ...
            out.write(NL);         
            out.write("  ");  //$NON-NLS-1$        
            RuntimeTagElement _jettag_ws_file_17_3 = context.getTagFactory().createRuntimeTag(_jetns_ws, "file", "ws:file", _td_ws_file_17_3); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_ws_file_17_3.setRuntimeParent(_jettag_ws_project_14_1);
            _jettag_ws_file_17_3.setTagInfo(_td_ws_file_17_3);
            _jettag_ws_file_17_3.doStart(context, out);
            _jettag_ws_file_17_3.doEnd();
            out.write(NL);         
            out.write(NL);         
            out.write("  ");  //$NON-NLS-1$        
            ...
            _jettag_ws_file_19_3.setRuntimeParent(_jettag_ws_project_14_1);
