...
public class _jet_comment implements JET2Template {
    ...
    private static final TagInfo _td_c_get_2_42 = new TagInfo("c:get", //$NON-NLS-1$
            2, 42,
            new String[] {
                "select", //$NON-NLS-1$
            },
            ...
            while (_jettag_c_if_1_64.okToProcessBody()) {
                ...
                while (_jettag_c_iterate_1_151.okToProcessBody()) {
                    ...
                    while (_jettag_c_replaceStrings_2_1.okToProcessBody()) {
                        ...
                        RuntimeTagElement _jettag_c_get_2_42 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_2_42); //$NON-NLS-1$ //$NON-NLS-2$
                        _jettag_c_get_2_42.setRuntimeParent(_jettag_c_replaceStrings_2_1);
                        _jettag_c_get_2_42.setTagInfo(_td_c_get_2_42);
                        _jettag_c_get_2_42.doStart(context, out);
                        _jettag_c_get_2_42.doEnd();
