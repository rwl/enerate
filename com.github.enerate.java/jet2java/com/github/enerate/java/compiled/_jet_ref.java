...
public class _jet_ref implements JET2Template {
    ...
    private static final TagInfo _td_c_if_1_112 = new TagInfo("c:if", //$NON-NLS-1$
            1, 112,
            new String[] {
                "test", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_get_2_95 = new TagInfo("c:get", //$NON-NLS-1$
            2, 95,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        RuntimeTagElement _jettag_c_if_1_112 = context.getTagFactory().createRuntimeTag(_jetns_c, "if", "c:if", _td_c_if_1_112); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_if_1_112.setRuntimeParent(null);
        _jettag_c_if_1_112.setTagInfo(_td_c_if_1_112);
        _jettag_c_if_1_112.doStart(context, out);
        while (_jettag_c_if_1_112.okToProcessBody()) {
            ...
            _jettag_c_get_2_37.setRuntimeParent(_jettag_c_if_1_112);
            _jettag_c_get_2_37.setTagInfo(_td_c_get_2_37);
            _jettag_c_get_2_37.doStart(context, out);
            _jettag_c_get_2_37.doEnd();
            _jettag_c_if_1_112.handleBodyContent(out);
        }
        _jettag_c_if_1_112.doEnd();
        out.write(" ");  //$NON-NLS-1$        
        RuntimeTagElement _jettag_c_get_2_95 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_2_95); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_get_2_95.setRuntimeParent(null);
        _jettag_c_get_2_95.setTagInfo(_td_c_get_2_95);
        _jettag_c_get_2_95.doStart(context, out);
        _jettag_c_get_2_95.doEnd();
        out.write(";");  //$NON-NLS-1$        
    }
}
