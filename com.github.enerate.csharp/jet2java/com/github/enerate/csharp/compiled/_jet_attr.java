...
public class _jet_attr implements JET2Template {
    ...
    private static final TagInfo _td_c_get_3_1 = new TagInfo("c:get", //$NON-NLS-1$
            ...
            new String[] {
                " className($eAttribute/eAttributeType/@instanceTypeName)", //$NON-NLS-1$
            } );
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        while (_jettag_c_choose_1_9.okToProcessBody()) {
            ...
            while (_jettag_c_when_2_1.okToProcessBody()) {
                ...
                _jettag_c_get_3_1.setRuntimeParent(_jettag_c_when_2_1);
            ...
            while (_jettag_c_otherwise_4_1.okToProcessBody()) {
                ...
                _jettag_c_get_5_1.setRuntimeParent(_jettag_c_otherwise_4_1);
