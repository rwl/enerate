...
public class GenerateAppEngineAction extends ActionDelegate implements IActionDelegate {
...
//            variables.put("org.eclipse.jet.resource.project.name", "theNameOfTheProjectContainingTheEMFResource");
            JET2Platform.runTransformOnObject("com.github.enerate.gae", genModel.eResource(), variables, monitor);
        }
    }
