...
public class _jet_subclasses implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_subclasses() {
        super();
    }
    ...
    private static final TagInfo _td_c_iterate_2_1 = new TagInfo("c:iterate", //$NON-NLS-1$
            ...
            new String[] {
                "$ePackage//EClass[count(eSuperTypes) > 0]", //$NON-NLS-1$
                "eClass", //$NON-NLS-1$
            } );
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write("/* Subclasses */");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        while (_jettag_c_iterate_2_1.okToProcessBody()) {
            ...
            _jettag_c_include_3_1.setRuntimeParent(_jettag_c_iterate_2_1);
