...
public class _jet_enums implements JET2Template {
    ...
    private static final TagInfo _td_c_get_4_35 = new TagInfo("c:get", //$NON-NLS-1$
            4, 35,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        while (_jettag_c_iterate_2_1.okToProcessBody()) {
            ...
            RuntimeTagElement _jettag_c_get_4_35 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_4_35); //$NON-NLS-1$ //$NON-NLS-2$
            _jettag_c_get_4_35.setRuntimeParent(_jettag_c_iterate_2_1);
            _jettag_c_get_4_35.setTagInfo(_td_c_get_4_35);
            _jettag_c_get_4_35.doStart(context, out);
            _jettag_c_get_4_35.doEnd();
            out.write(NL);         
